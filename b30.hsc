...
(fade_in 1 1 1 15 )
(game_save )
(ai_conversation shafta_switch )(ai true ))
...
(sleep_until (or (volume_test_objects crack_arrival_trigger (players ))global_shafta_unlocked )10 )(if (not global_shafta_unlocked )(ai_conversation crack_arrival )))

(script dormant shaftb_arrival
(sleep_until (or global_shafta_unlocked global_shafta_known_locked ))
(sleep_until (or (volume_test_objects downed_trigger (players ))global_shafta_unlocked )10 )(if (not global_shafta_unlocked )(ai_conversation shaftb_arrival )))
...
(if (game_is_cooperative )(sleep_until (and (vehicle_test_seat_list extraction_pelican "p-riderlf" (players ))(vehicle_test_seat_list extraction_pelican "p-riderrf" (players )))1 ))
...
(sleep 150 )
(if (not test_ledge )(cinematic_show_letterbox false ))
(if (not test_ledge )(show_hud true ))
...
(sleep_until (and (= 0 (ai_living_count shafta_ante/rein_elite ))(volume_test_objects shafta_switch (players )))10 )(if (not global_shafta_switched )(ai_conversation shafta_switchit )))
...
(show_hud true )
(cinematic_stop )
(set mark_activate_2 true )(ai_erase unlock_elite ))
