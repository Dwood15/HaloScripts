...
(sleep -1 )
(print "blah blah blah" )(sound_impulse_start "sound\dialog\a10\a10_flavor_210_captkeyes" none 0.5 ))
...
(sleep (random_range (* 30 60 )(* 30 120 )))(if (not global_rumble )(sleep (random_range (* 30 30 )(* 30 60 )))))

(script continuous flavor_rumble
(sleep (* (random_range (* 30 45 )(* 30 75 ))(+ 0.25 (max 0 (* 0.125 (- 6 (structure_bsp_index )))))))(if test_bridge_active (begin (sleep 120 ))(if (not global_rumble )
(begin (sleep 120 ))(if (= (structure_bsp_index )0 )
...
(if (and (not (game_is_cooperative ))(= (game_difficulty_get )impossible ))(sleep_until (volume_test_objects meg_egg (players ))delay_dawdle ))(if (and (not (game_is_cooperative ))(= (game_difficulty_get )impossible ))(set global_meg_egg true )))
...
(if (not (or (player_action_test_look_relative_up )(player_action_test_look_relative_down )))(if (player0_joystick_set_is_normal )
...
(sleep (sound_impulse_time "sound\dialog\a10\a10_090_cryotech" ))(sleep_until (volume_test_objects red_square (players ))1 )))(set mark_tutorial_moving_1 true ))
...
(sound_impulse_start "sound\dialog\a10\a10_210_cryoassist" none 1 )(sound_impulse_start "sound\dialog\a10\a10_220_cryoassist" none 1 ))
...
(begin (wake fast_setup ))(if (not (= normal (game_difficulty_get )))
(begin (wake fast_setup ))(if true (begin (wake tutorial_setup )) )))
(wake mission_bsp )
(wake music_a10 )
(wake linkage )
...
(wake flavor_watchit )
(if (game_is_cooperative )
(begin (ai_grenades true ))(if (not (= normal (game_difficulty_get )))
(begin (ai_grenades true ))(if true (begin (ai_grenades false )) )))
(wake mission_shoot )
...
(wake mission_tunnel )
(wake cryo_search )
(wake mission_boom )(wake mission_final ))
...
(device_set_position x10_battle_11 1 )(device_set_position x10_battle_12 1 ))
