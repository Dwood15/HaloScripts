...
(unit_enter_vehicle (player0 )insertion_pelican "p-riderlf" )(unit_enter_vehicle (player1 )insertion_pelican "p-riderrf" ))
...
(sleep (sound_impulse_time "sound\dialog\b40\b40_insert_020_pilot" ))(sound_class_set_gain "vehicle" 1 6 ))

(script static "void" grunt_test
(object_teleport awake_1 grunt_panic_base )(custom_animation awake_1 "cinematics\animations\grunt\level_specific\b40\b40" "b40_runaway" true ))
...
(sleep 40 )(sound_looping_start "sound\sinomatixx_music\b40_extraction_music" none 1 ))
...
(recording_kill awake_1 )
(object_destroy awake_1 )
(object_destroy sleepy_1 )(object_destroy sleepy_2 ))
...
(sleep_until (> (ai_conversation_status a_bridge_marines )3 ))(sound_looping_start "levels\b40\music\b40_01" none 1 ))
...
(sleep_until (or (volume_test_objects a2_top_b_save (players ))(= (ai_living_count a2_top_cov )0 )))(sound_looping_stop "levels\b40\music\b40_011" ))

(script dormant music_b40_02
(sleep_until (= (device_get_position lift_a )1 ))
(sound_looping_start "levels\b40\music\b40_02" none 1 )
(sleep_until (> (device_get_position ext_a_door )0 ))(sound_looping_stop "levels\b40\music\b40_02" ))
...
(<= (unit_get_health crev_ent_wraith_b )0 )(volume_test_objects ext_a_c_door (players ))))(sound_looping_stop "levels\b40\music\b40_03" ))
...
(sleep_until (not play_music_b40_04 ))(sound_looping_stop "levels\b40\music\b40_04" ))

(script dormant music_b40_041
(sound_looping_start "levels\b40\music\b40_041" none 1 )
(sleep_until (not play_music_b40_041 ))(sound_looping_stop "levels\b40\music\b40_041" ))
...
(sleep_until (> (device_get_position lift_c )0 ))(sound_looping_stop "levels\b40\music\b40_042" ))
...
(sleep_until (not play_music_b40_05 ))(sound_looping_stop "levels\b40\music\b40_05" ))
...
(sleep 30 )
(sleep_until (or (= (ai_living_count b4_bridge/stealth_elites )0 )(not play_music_b40_06 )))(sound_looping_stop "levels\b40\music\b40_06" ))
...
(sleep 30 )
(sleep_until (or (not play_music_b40_061 )(= (ai_living_count b5_b_cov/hunters )0 )))(sound_looping_stop "levels\b40\music\b40_061" ))
...
(sleep_until (not play_music_b40_07 )30 (* 30 89 ))(sound_looping_stop "levels\b40\music\b40_07" ))
...
(sleep_until (or (> (device_get_position ext_c_ent_door )0 )(not play_music_b40_071 )))(sound_looping_stop "levels\b40\music\b40_071" ))
...
(sleep_until (not play_music_b40_08 ))(sound_looping_stop "levels\b40\music\b40_08" ))

(script dormant dialog_a1_clear
(sleep_until (= (ai_living_count a1_cov )0 ))
(sleep 60 )(ai_conversation a1_clear ))

(script dormant dialog_a_bridge_ini
(sleep_until (= (ai_status a_bridge )6 )30 300 )(ai_conversation a_bridge_marines ))

(script dormant dialog_ext_a_a_clear
(sleep_until (= (ai_living_count ext_a_area_a_cov )0 ))(if (= (volume_test_objects ext_a_area_b_trigger (players ))false )(ai_conversation ext_a_a_clear )))
...
(sleep 30 )(ai_conversation ext_a_c_wraith_eng ))
...
(sleep 60 )(ai_conversation ext_a_c_wraith_des ))

(script dormant dialog_ext_a_c_door
(sleep_until (volume_test_objects ext_a_c_door (players )))
(ai_conversation crev_door )
(sleep_until (> (device_get_position garagedoor_a )0 ))(ai_conversation crev_door_open ))

(script dormant dialog_scorpion_dead
(sleep_until (<= (unit_get_health ext_a_tank )0 ))(ai_conversation scorpion_destroyed ))

(script dormant dialog_ext_b_c_clear
(sleep 30 )
(sleep_until (= (ai_living_count ext_b_area_c_cov )0 ))(if (> (ai_living_count ext_b_marines )0 )(ai_conversation ext_b_c_clear )))

(script dormant dialog_ext_b_c
(sleep 60 )(ai_conversation ext_b_c ))

(script dormant dialog_b5_clear
(sleep_until (= (ai_living_count b5_b_cov )0 ))
(sleep 60 )(ai_conversation b5_clear ))

(script dormant dialog_ext_c_ini
(sleep_until (> (device_get_position ext_c_ent_door )0 ))
(sleep 30 )(ai_conversation ext_c_ini ))
...
(sleep 30 )(ai_conversation c_bridge_banshee_takeoff ))

(script dormant dialog_control_clear
(sleep_until (= (ai_living_count control_cov )0 ))
(sleep 60 )(ai_conversation control_clear ))
...
(sleep 90 )(cinematic_set_title intro ))
...
(object_teleport c_dropship_b ext_b_b_dropship_b )(recording_play_and_delete c_dropship_b ext_b_b_dropship_b_out ))
...
(ai_playfight ext_a_area_a_cov/grunts_e false )(ai_conversation ext_a_marines ))
...
(sleep_until (volume_test_objects crev_dialog_trigger (players )))(ai_conversation enter_crev ))
...
(sleep 150 )(ai_conversation ext_b_b_ini ))
...
(sleep 1 )
(objects_predict (ai_actors c_bridge ))(device_set_position c_bridge_far_door 1 ))
...
(objects_predict ext_c_ghost_a )(device_set_power ext_c_ent_door 1 ))
...
(ai_migrate crevasse_cov_a crevasse_cov_b/squad_all )(sound_looping_set_alternate "levels\b40\music\b40_04" true ))
...
(wake enc_c_bridge_reins )(device_one_sided_set c_bridge_far_door false ))
...
(sleep -1 ini_tank_exit_b )(sleep -1 general_save ))
